...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of ShortnerFly than **contact** at 👉 @pdiskshortnearn_xyz (all **shortners support** available.)
...
Ex: https://t.me/pdiskshortnearn | pdiskshortnearn"""
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'https://pdiskshortnearn.xyz/member/tools/api')
    ]
])
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://pdiskshortnearn.xyz)
...
Get API From [{base_site}](https://pdiskshortnearn.xyz)
...
**example:**
/channel @pdiskshortnearn
Or
/channel https://t.me/pdiskshortnearn

**🤘 Hit** 👉 /features To Know More Features Of This Bot.

**- Message @pdiskshortnearn_xyz For More Help -**"""
